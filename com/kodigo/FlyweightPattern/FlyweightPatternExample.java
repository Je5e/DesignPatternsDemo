...
import com.kodigo.FlyweightPattern.Robot;
import com.kodigo.FlyweightPattern.RobotFactory;
...
public class FlyweightPatternExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            myRobot = RobotFactory.getRobotFomFactory("small");
   /*
   ...
   */
        ...
        for (int i = 0; i < 5; i++) {
            myRobot = RobotFactory.getRobotFomFactory("large");
 /*
 Not required to add sleep().But it is included to
 increase the probability of getting a new random number
 to see the variations in the output.
 */
        ...
        for (int i = 0; i < 4; i++) {
            myRobot = RobotFactory.getRobotFomFactory("fixed");
 /*
 Not required to add sleep().But it is included to
 increase the probability of getting a new random number
 to see the variations in the output.
